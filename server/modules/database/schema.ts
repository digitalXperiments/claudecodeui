...
CREATE TABLE IF NOT EXISTS sessions (
    ...
    jsonl_path TEXT,
    -- Internal automation sessions (relay workers, bots, etc.) are
...
CREATE TABLE IF NOT EXISTS agent_run_profiles (
    ...
    -- 0 = disabled: kept for explicit/manual use but excluded from
    -- automatic selection.
...
CREATE TABLE IF NOT EXISTS agent_relay_jobs (
    ...
    model_label          TEXT,
    catalog_default_model TEXT,
    catalog_resolved_model TEXT,
    runtime_resolved_model TEXT,
    model_selection_source TEXT,
    effort               TEXT,
