 ...
 * rewrites history (a new turn, an edit, a fork) touches the file and
 * invalidates naturally; no explicit invalidation hooks exist or are needed.
 *
 ...
 * elsewhere (Cursor's store.db, OpenCode's shared SQLite, Grok's sibling
 * chat_history.jsonl), which bypasses caching entirely.
 */
