...
export const newBotId = (): string => `bot_${ulid()}`;
export const newBotVersionId = (): string => `bver_${ulid()}`;
export const newBotTickId = (): string => `btick_${ulid()}`;
export const newBotProposalId = (): string => `bprop_${ulid()}`;
export const newIntegrationAccountId = (): string => `iacct_${ulid()}`;
export const newIntegrationGrantId = (): string => `igrant_${ulid()}`;
export const newIntegrationCallId = (): string => `icall_${ulid()}`;
