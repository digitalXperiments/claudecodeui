...
export const CLI_PROVIDERS: LLMProvider[] = ['claude', 'cursor', 'codex', 'opencode', 'kilo', 'cline', 'grok', 'kimi', 'qwencode', 'pi', 'omp', 'antigravity'];
...
export const createInitialProviderAuthStatusMap = (loading = true): ProviderAuthStatusMap => ({
  ...
  antigravity: { installed: null, authenticated: false, email: null, method: null, error: null, loading },
});
