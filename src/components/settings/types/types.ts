...
export type SettingsMainTab = 'agents' | 'agent-profiles' | 'continuity' | 'jev' | 'studio' | 'evals' | 'mcp' | 'skills' | 'hooks' | 'global-skills' | 'memory' | 'appearance' | 'git' | 'api' | 'secrets' | 'voice' | 'tasks' | 'browser' | 'notifications' | 'plugins' | 'webhooks' | 'backups' | 'security' | 'about';
