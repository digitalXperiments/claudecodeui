...
export type SettingsMainTab = 'agents' | 'agent-profiles' | 'model-registry' | 'agent-relay' | 'studio' | 'evals' | 'mcp' | 'skills' | 'global-skills' | 'memory' | 'appearance' | 'git' | 'api' | 'secrets' | 'voice' | 'tasks' | 'browser' | 'notifications' | 'plugins' | 'webhooks' | 'security' | 'about';
