...
type ShellConnectionOverlayProps = {
  mode: 'loading' | 'waiting' | 'connect' | 'connecting';
  description: string;
  loadingLabel: string;
  waitingLabel: string;
  connectLabel: string;
    ...
    return (
      <div className="absolute inset-0 z-20 flex items-center justify-center bg-background/90 p-6">
        <div className="flex w-full max-w-md flex-col items-center gap-3 text-center">
          <div className="flex items-center justify-center gap-3 text-amber-600 dark:text-yellow-300">
